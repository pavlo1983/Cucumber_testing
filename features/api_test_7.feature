Feature: Verify status response code and properties in error object 
  Check that the HTTP status code of the response is 404 and the error object had the properties ‘details’ and ‘http_response_code’
